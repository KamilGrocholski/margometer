 ...
 *
 * The inverse of what `src/ui/panel-words.ts` formats, and the guards over the share column all
 * need it. The floor comes from that module rather than from a copy here: a guard holding the
 * panel to a string the panel stopped drawing is a guard measuring nothing.
 */
