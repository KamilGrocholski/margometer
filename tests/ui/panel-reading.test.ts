 ...
 * was stopped — so the sample is the two messages that shape one. `develop`'s
 * `deno task panel:drill` over `captures/` on 2026-08-30: 53 of the 81 skills announced deal
 * something, and none of the other 28 ever swung.
 */
