...
- `docs/README.md` opisuje dwie rzeczy, których nie ma: przekrój „Ta walka /
  Sesja" oraz „najechanie na wiersz → pełne rozbicie" (hover daje skrót,
  rozbicie jest pod LPM).
