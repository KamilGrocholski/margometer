...
|---|---|---|
| [`README.md`](README.md) | **Dlaczego kod wygląda tak, jak wygląda?** Czego log NIE mówi i co z tego wynika. Sekcje o truciźnie bez sprawcy, leczeniu bez leczącego, duplikatach nazw, kolorach, „na turę". | Zawsze, zanim zmienisz cokolwiek w `parser.ts` albo `stats.ts` |
...
| [**Mechanika walk**](https://pomoc.margonem.pl/index/view,372) | Jedyny artykuł pomocy, na którym opiera się wprost decyzja w kodzie. Cztery sekcje: system walki, system tur, statystyki postaci w walce, atrakcje. Są tam formuły przewagi poziomowej dla **uniku, bloku i ciosu krytycznego** oraz wzmianka o „broniach od zimna i trucizny" — to z niej wynika, że trucizna jest właściwością BRONI (patrz `README.md`, „Trucizna bez sprawcy") |
...
Cała sekcja o tym jest w `README.md` — łącznie z tym, które piętra wnioskowania
