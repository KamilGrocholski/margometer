...
/**
 * What stands over the frozen counts, exported so a guard can hold the file to its generator
 * without the cached dump a regeneration needs — the drift the key table's banner showed first.
 */
