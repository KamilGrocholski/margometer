...
`max-height` · `min-height` · `min-width` · `opacity` · `overflow` · `overflow-wrap` · `overflow-x`
...
`mask-image: transparent` · `overflow: hidden` · `overflow-wrap: break-word` · `overflow-x: hidden`
